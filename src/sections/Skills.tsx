...
const SKILL_DATA: SkillGroup[] = [
  {
    category: "Core Frontend & Frameworks",
    items: ["React.js", "TypeScript", "Next.js", "JavaScript (ES6+)", "HTML5 / CSS3", "ShadCN"]
  },
  {
    category: "Styling & Layout",
    items: ["Tailwind CSS", "Responsive Design", "Web Performance", "UI Optimization"]
  },
  {
    category: "State Management & APIs",
    items: ["Zustand", "Redux", "REST APIs", "GraphQL", "Node.js", "Express.js", "Zod Validation"]
  },
  {
    category: "Tools & Testing Ecosystems",
    items: ["Git & GitHub", "GitHub Actions", "Azure DevOps", "CI/CD", "MongoDB", "PostgreSQL", "Prisma / Mongoose", "Sentry"]
  }
];
